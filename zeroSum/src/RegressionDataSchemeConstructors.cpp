...
void RegressionDataScheme::regressionDataSchemeShallowCopy( const RegressionDataScheme& source )
{
    x      = source.x;
    yOrg   = source.yOrg;
    v      = source.v;
...
void RegressionDataScheme::regressionDataSchemeDeepCopy( const RegressionDataScheme& source )
{
...
void RegressionDataScheme::regressionDataSchemePointerMove( RegressionDataScheme& source )
{
    y                    = source.y;
    w                    = source.w;
    wOrg                 = source.wOrg;
...
RegressionDataScheme& RegressionDataScheme::operator=( const RegressionDataScheme& source )
{
    regressionDataSchemeFree();
    regressionDataSchemeShallowCopy(source);
    regressionDataSchemeAlloc();
...
RegressionDataScheme& RegressionDataScheme::operator=( RegressionDataScheme&& source )
{
    regressionDataSchemeShallowCopy(source);
    regressionDataSchemePointerMove(source);
    return *this;
