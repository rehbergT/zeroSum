...
void sub_a_times_scalar_b_sub_c_times_scalar_d(double* a, double b, double* c, double d, double* e, int n)
{
    if(n < 4)
    {
        for( int i=0; i<n; ++i )
...
void sub_a_times_scalar_b_sub_c_times_scalar_d_sub_d_times_scalar_f(double* a, double b, double* c, double d, double* e, double f, double* res, int n)
{
    if(n < 4)
    {
        for( int i=0; i<n; ++i )
...
void a_add_scalar_b_times_c_sub_d_times_e( double* a, double b, double* c, double* d, double e, double* res, int n )
{
    if(n < 4)
    {
        for( int i=0; i<n; ++i )
...
void a_times_scalar_b_add_c_times_scalar_d_add_d_times_scalar_f(  double* a, double b, double* c, double d, double* e, double f, double* res, int n )
{
    if(n < 4)
    {
        for( int i=0; i<n; ++i )
...
int deleteFromSet( int* activeset, int* activesetSize, int k)
{
    for( int i=0; i< *activesetSize; i++)
    {
        if( activeset[i]==k )
        {
            int toCopy = *activesetSize - i - 1;

            if( toCopy > 0 )
                memmove( &activeset[i], &activeset[i+1], toCopy * sizeof(int));
