...
test_that("regression weights seem to be okay", {
    ...
    w <- c(
        0.507478203158826, 0.306768506066874, 0.426907666493207,
        0.693102080840617, 0.0851359688676894, 0.225436616456136,
        0.274530522990972, 0.272305066231638, 0.615829307818785,
        0.429671525489539, 0.651655666995794, 0.567737752571702,
        0.113508982118219, 0.595925305271521, 0.358049975009635,
        0.428809418343008, 0.0519033221062273, 0.264177667442709,
        0.398790730861947, 0.836134143406525, 0.864721225807443,
        0.615352416876704, 0.775109896436334, 0.355568691389635,
        0.405849972041324, 0.706646913895383, 0.838287665275857,
        0.239589131204411, 0.770771533250809, 0.355897744419053,
        0.535597037756816
    )
    u <- rep(1, P)
    v <- rep(1, P)
