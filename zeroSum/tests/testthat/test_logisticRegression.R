...
test_that("logistic regression equals glmnet", {
    ...
    ## logistic Regression
    A <- zeroSum(x, y, alpha, lambda, algorithm = "CD", standardize = FALSE,
    ...
    B <- zeroSum(x, y, alpha, lambda, algorithm = "CD", standardize = FALSE,
                 family = "binomial")
    ...
    C <- zeroSum(x, y, alpha, lambda, algorithm = "CD", standardize = TRUE,
                 family = "binomial", zeroSum = FALSE)
    ...
    D <- zeroSum(x, y, alpha, lambda, algorithm = "CD", standardize = TRUE,
                 family = "binomial")
    ...
    FA1 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = FALSE,
                   gamma = gamma, fusion = fusion, family = "binomial",
                   zeroSum = FALSE)
    eFA1 <- extCostFunction(x, y, coef(FA1), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA2 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = FALSE,
                   gamma = gamma, fusion = fusion, useApprox = FALSE,
                   family = "binomial", zeroSum = FALSE)
    eFA2 <- extCostFunction(x, y, coef(FA2), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA3 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = FALSE,
                   gamma = gamma, fusion = fusion, family = "binomial")
    eFA3 <- extCostFunction(x, y, coef(FA3), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA4 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = FALSE,
                   gamma = gamma, fusion = fusion, useApprox = FALSE,
                   family = "binomial")
    eFA4 <- extCostFunction(x, y, coef(FA4), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA5 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = TRUE,
                   gamma = gamma, fusion = fusion, family = "binomial",
                   zeroSum = FALSE)
    eFA5 <- extCostFunction(x, y, coef(FA5), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA6 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = TRUE,
                   gamma = gamma, fusion = fusion, useApprox = FALSE,
                   family = "binomial", zeroSum = FALSE)
    eFA6 <- extCostFunction(x, y, coef(FA6), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA7 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = TRUE,
                   gamma = gamma, fusion = fusion, family = "binomial")
    eFA7 <- extCostFunction(x, y, coef(FA7), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    FA8 <- zeroSum(x, y, alpha, lambda, algorithm = "LS", standardize = TRUE,
                   gamma = gamma, fusion = fusion, useApprox = FALSE,
                   family = "binomial")
    eFA8 <- extCostFunction(x, y, coef(FA8), alpha, lambda, family = "binomial",
                            gamma = gamma, fusion = fusion)

    costs <- c(eFA1$cost, eFA2$cost, eFA3$cost, eFA4$cost, eFA5$cost, eFA6$cost,
               eFA7$cost, eFA8$cost)
