    ...
    test_that( "rotated zerosum coordinate descent move seems to work",{
        ...
        zeroSumCdRT <- function( data, n, m, s, theta  )
        {
            ...
            c1 <-  data$v[n]*cos(theta) - data$v[m]*sin(theta) + data$v[s] * ( -data$u[n]*cos(theta) + data$u[m]*sin(theta)) / data$u[s]
            c2 <-  data$v[n]*cos(theta) - data$v[m]*sin(theta) + data$v[s] * (  data$u[n]*cos(theta) - data$u[m]*sin(theta)) / data$u[s]
            c3 <-  data$v[n]*cos(theta) + data$v[m]*sin(theta) + data$v[s] * ( -data$u[n]*cos(theta) + data$u[m]*sin(theta)) / data$u[s]
            c4 <-  data$v[n]*cos(theta) + data$v[m]*sin(theta) + data$v[s] * (  data$u[n]*cos(theta) - data$u[m]*sin(theta)) / data$u[s]
            c5 <- -data$v[n]*cos(theta) - data$v[m]*sin(theta) + data$v[s] * ( -data$u[n]*cos(theta) + data$u[m]*sin(theta)) / data$u[s]
            c6 <- -data$v[n]*cos(theta) - data$v[m]*sin(theta) + data$v[s] * (  data$u[n]*cos(theta) - data$u[m]*sin(theta)) / data$u[s]
            c7 <- -data$v[n]*cos(theta) + data$v[m]*sin(theta) + data$v[s] * ( -data$u[n]*cos(theta) + data$u[m]*sin(theta)) / data$u[s]
            c8 <- -data$v[n]*cos(theta) + data$v[m]*sin(theta) + data$v[s] * (  data$u[n]*cos(theta) - data$u[m]*sin(theta)) / data$u[s]
