...
### Manual Installation
##### Windows
Download the precompiled [<em>windows package</em>](https://github.com/rehbergT/zeroSum/raw/master/zeroSum_1.0.4.zip) (a zip file), open an
R session as admin, navigate to the folder with the zip file and install it with:

    install.packages("zeroSum_1.0.4.zip", repos = NULL)

##### Linux
Download the [<em>package</em>](https://github.com/rehbergT/zeroSum/raw/master/zeroSum_1.0.4.tar.gz), open an
R session as admin, navigate to the folder with the tar.gz file and install it with:

    install.packages("zeroSum_1.0.4.tar.gz", repos = NULL)
...
Build and install the created package:
    ...
    R CMD build zeroSum
    R CMD INSTALL zeroSum_1.0.4.tar.gz
