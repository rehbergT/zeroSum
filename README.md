...
Open an R session as admin and install the package:
    ...
    install.packages("https://github.com/rehbergT/zeroSum/raw/master/zeroSum_1.1.1.zip", repos = NULL)
...
### Manual Installation
##### Windows
Download the precompiled [<em>windows package</em>](https://github.com/rehbergT/zeroSum/raw/master/zeroSum_1.1.1.zip) (a zip file), open an
R session as admin, navigate to the folder with the zip file and install it with:

    install.packages("zeroSum_1.1.1.zip", repos = NULL)

##### Linux
Download the [<em>package</em>](https://github.com/rehbergT/zeroSum/raw/master/zeroSum_1.1.1.tar.gz), open an
R session as admin, navigate to the folder with the tar.gz file and install it with:

    install.packages("zeroSum_1.1.1.tar.gz", repos = NULL)
...
Build and install the created package:
    ...
    R CMD build zeroSum
    R CMD INSTALL zeroSum_1.1.1.tar.gz
...
**This command overwrites the ~/.R/Makevars file!**
    ...
    echo "CXX11FLAGS += -march=native -mtune=native -O3 -flto" > ~/.R/Makevars
...
<em>zeroSum</em> supports linear regression (gaussian response) and logistic regression (with binomial and multinomial response) and Cox proportional hazard regression.
